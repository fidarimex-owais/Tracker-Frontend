...
import Scanner from './pages/supervisor/Scanner';
      ...
      <AuthProvider>
        <Routes>
          ...
          <Route element={<ProtectedRoute roles={['subadmin']} />}>
            <Route path="/sub-admin" element={<PortalLayout />}>
          ...
          <Route element={<ProtectedRoute roles={['vendor']} />}>
            <Route path="/vendor" element={<PortalLayout />}>
          ...
          <Route element={<ProtectedRoute roles={['supervisor']} />}>
            <Route path="/supervisor" element={<PortalLayout />}>
